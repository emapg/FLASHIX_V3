...
⭕️👉 Powered By @flashixv             ┌──────────────────┐
⭕️👉 Channel : @flashixv             │┏┳┓┏┳┓╺┳┓┏━┓╺━┓┏━┓│
⭕️👉 Wwbsite : flashixv             │┃┃┃┃┃┃ ┃┃┣┳┛┏━┛┣━┫│
⭕️👉 Github.Com/ flashixv             │╹ ╹╹ ╹╺┻┛╹┗╸┗━╸╹ ╹│
⭕️👉 Dev.to/@flashixv                 └──────────────────┘
'''
...
mmdrzaxlog = '''
# Powered By FLASH_CORE            ┌──────────────────┐
# Channel : FLASH_CORE_OP          │┏┳┓┏┳┓╺┳┓┏━┓╺━┓┏━┓│
# Wwbsite : COMING SOON            │┃┃┃┃┃┃ ┃┃┣┳┛┏━┛┣━┫│
# Github.Com/FLASH_CORE            │╹ ╹╹ ╹╺┻┛╹┗╸┗━╸╹ ╹│
# Dev.to/FLASH_CORE                └──────────────────┘
'''
...
print(Fore.RED + 'ℹ️ FLASHIX VERSION3 READY FOR ATTACKING ...')
...
print(Fore.WHITE + '[2]' + Fore.RED + ' PLEASE KEEP IN YOUR MIND WITHOUT LICENSE CODE FLASHIXX V3 NOT WORKS' + Style.RESET_ALL)
print(Fore.WHITE + '[3]' + Fore.RED + ' *** SCAMMER ALERT*** DEVOLOPER FLASH_CORE OTHERS ALL SCAM' + Style.RESET_ALL)
time.sleep(0.3)
input_speed = input(Fore.YELLOW + 'ENTER YOUR LICENSE CODE (16 DIGIT) = ' + Style.RESET_ALL)
time.sleep(0.2)
print(Fore.RED + '========================================================')
